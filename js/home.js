  ...
  .get().then((snapshot)=> {
    snapshot.forEach(doc=> {
      ...
      if(doc.data().giftcode=="gift-99") {
        str +='<div><b>เสียใจด้วยน้า</b> คุณไม่ได้รับรางวัล<br>จาก ... <b>กิจกรรมไหว้พระจันทร์</b><br>แล้วมาร่วมกิจกรรมกันใหม่ในกิจกรรมหน้าน้า</div>';
        str +='<div class="clr"></div>';
      } else {
        str +='<div><b>ยินดีด้วย</b> คุณได้รับรางวัล<br>จาก ... <b>กิจกรรมไหว้พระจันทร์</b><br>ของรางวัลที่สุ่มได้คือ <b>'+ doc.data().giftname +'</b><br>เราจะทำการจัดส่งของรางวัลไปให้หลังจบกิจกรรมนี้</div>';
        str +='<div class="clr"></div>';
      }
      str +='</center>';
...
function OpenCake(n,x) {
  ...
  .get().then((snapshot)=> {
    ...
    if(gcheck==0) {
      ...
      str +='<div class="text-product">ขนมไหว้พระจันทร์ '+ x +'</div>';
      ...
      str +='<div class="btn-t2" onclick="CloseAll()" style="margin:10px auto;background:#ff0000;border:2px solid #fff; color:#fff;">เลือกขนมใหม่</div>';
...
function ShowRewards() {
  ...
  if(NewRewards[2]=="gift-99") {
    ...
    str +='<div><b>ยินดีด้วย</b> คุณได้รับรางวัล<br>จาก ... <b>กิจกรรมไหว้พระจันทร์</b><br>ของรางวัลที่สุ่มได้คือ <b>'+ NewRewards[1] +'</b><br>เราจะทำการจัดส่งของรางวัลไปให้หลังจบกิจกรรมนี้</div>';
  }
  str +='<div class="btn-t2" onclick="CloseAll()" style="margin-top:10px;">ปิดหน้าต่างนี้</div>';
  str +='<div class="clr"></div></center>';
  $("#ShowMoonCake").html(str);
